========================================================================
       CLUSTER ADMINISTRATOR EXTENSION : B2CService
========================================================================
...
B2CServiceEx.h
    ...
    CB2CServiceApp class.

B2CServiceEx.cpp
    This is the main DLL source file.  It contains the class CB2CServiceApp.
...
StdAfx.h, StdAfx.cpp
    ...
    named B2CService.pch and a precompiled types file named StdAfx.obj.
...
ResProp.h
    ...
    written.  It defines the CB2CServiceParamsPage class.

ResProp.cpp
    This is the source file which implements the CB2CServiceParamsPage class.
...
(typically C:\MSDEV\BIN):
    ...
    RegClAdm [/cclustername] B2CServiceEx.dll
