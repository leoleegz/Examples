...
#include "ExtObjID.h"	// for CLSID_CoB2CServiceEx
#endif
...
class CExtObject :
	...
	public CComCoClass<CExtObject, &CLSID_CoB2CServiceEx>
{
public:
	CExtObject(void);
...
DECLARE_REGISTRY(CExtObject, _T("CLUADMEX.B2CServiceEx"), _T("CLUADMEX.B2CServiceEx"), IDS_CLUADMEX_COMOBJ_DESC, THREADFLAGS_APARTMENT)
